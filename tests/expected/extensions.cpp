...
{
  auto succeed = [](int a) { return eml::expected<int, int>(21 * 2); };
  auto fail = [](int a) { return eml::expected<int, int>(eml::unexpect, 17); };
...
TEST_CASE("or_else", "[expected.or_else]")
{
  ...
  auto succeed = [](int a) { return eml::expected<int, int>(21 * 2); };
  auto succeedptr = [](eptr e) { return eml::expected<int, eptr>(21 * 2); };
  auto fail = [](int a) { return eml::expected<int, int>(eml::unexpect, 17); };
  auto efail = [](eptr e) {
    *e = 17;
